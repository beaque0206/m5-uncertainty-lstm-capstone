...
store_dep_pred = read_csv('level9_pred_events.csv', header=None)
...
with open('level12_wkdmne1pred.csv','w',newline='') as file:
...
level12_pred = read_csv('level12_wkdmne1pred.csv',header = None)
...
with open('level11_wkdmne1pred.csv','w',newline='') as file:
    writer=csv.writer(file)
    writer.writerows(prediction_lines)
...
with open('level10_wkdmne1pred.csv','w',newline='') as file:
    writer=csv.writer(file)
    writer.writerows(prediction_lines)
...
level9_pred = read_csv('level9_pred_events.csv',header=None)
...
with open('level08_wkdmne1pred.csv','w',newline='') as file:
    writer=csv.writer(file)
    writer.writerows(prediction_lines)
...
with open('level07_wkdmne1pred.csv','w',newline='') as file:
    writer=csv.writer(file)
    writer.writerows(prediction_lines)
...
level7_pred = read_csv('level07_wkdmne1pred.csv',header=None)
...
with open('level06_wkdmne1pred.csv','w',newline='') as file:
    writer=csv.writer(file)
    writer.writerows(prediction_lines)
...
with open('level05_wkdmne1pred.csv','w',newline='') as file:
    writer=csv.writer(file)
    writer.writerows(prediction_lines)
...
level6_pred = read_csv('level06_wkdmne1pred.csv',header=None)
...
with open('level04_wkdmne1pred.csv','w',newline='') as file:
    writer=csv.writer(file)
    writer.writerows(prediction_lines)
...
level8_pred = read_csv('level08_wkdmne1pred.csv',header=None)
...
with open('level03_wkdmne1pred.csv','w',newline='') as file:
    writer=csv.writer(file)
    writer.writerows(prediction_lines)
...
with open('level02_wkdmne1pred.csv','w',newline='') as file:
    writer=csv.writer(file)
    writer.writerows(prediction_lines)
...
level2_pred = read_csv('level02_wkdmne1pred.csv',header=None)
...
with open('level01_snap_pred.csv','w',newline='') as file:
    writer=csv.writer(file)
    writer.writerows(prediction_lines)
